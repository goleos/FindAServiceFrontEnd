...
import { faBellConcierge, faCalendar, faEnvelope, faLocationDot, faPencil } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <ServiceDetails>
                        ...
                        <AreasCoveredContainer>
                            ...
                            <TagsContainer>
                                {service.areasCovered.map((area) => (
                                    <Chip key={area} tabIndex={-1} label={area} />
                                ))}
                            </TagsContainer>
                        </AreasCoveredContainer>
                        <AvailabilityContainer>
                            ...
                            {service.availability.map((day) => (
                                <Chip key={day} tabIndex={-1} label={day} />
                            ))}
                        </AvailabilityContainer>
                    </ServiceDetails>
                    <ActionsContainer>
                        ...
                        <ButtonsContainer>
                            ...
                            {customer && (
                                <IconButton icon={faBellConcierge} name="Request" onClick={handleOpenDialog} />
                            )}
                        </ButtonsContainer>
                    </ActionsContainer>
                </Header>
